//! A gadget for a non-native scalar mul
//! inspired by https://github.com/privacy-scaling-explorations/halo2wrong/
...
// pub use self::chip::NNScalarMulChip;

// pub trait NNScalarMulInstructions<F: Field>: Chip<F> {
//   type Num;
...
// impl<F: Field> NNScalarMulInstructions<F> for NNScalarMulChip<F> {
//   type Num = Number<F>;
...
// #[derive(Clone, Debug)]
// pub struct NNScalarMulConfig {
//   pub advice:   [Column<Advice>; 2],
//   pub instance: Column<Instance>,
//   pub s_mul:    Selector,
// }

// impl NNScalarMulConfig {
...
//     NNScalarMulConfig { advice, instance, s_mul }
//   }
// }
...
//   use super::NNScalarMulConfig;

//   #[derive(Clone)]
//   pub struct NNScalarMulChip<F: Field> {
//     config:  NNScalarMulConfig,
//     _marker: PhantomData<F>,
//   }
//   impl<F: Field> Chip<F> for NNScalarMulChip<F> {
//     type Config = NNScalarMulConfig;
//     type Loaded = ();
...
//   impl<F: Field> NNScalarMulChip<F> {
